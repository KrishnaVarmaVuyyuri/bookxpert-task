                    ...
                    {employees.map((emp) => (
                        <tr key={emp.id} className="hover:bg-gray-50">
                            ...
                            <td className="px-4 py-3 text-sm">
                                ...
                                <button onClick={() => onEdit && onEdit(emp)} className="text-indigo-600 hover:text-indigo-800 mr-2">Edit</button>
                                <button onClick={() => handleDelete(emp.id)} className="text-red-600 hover:text-red-800 mr-2">Delete</button>
                                <button onClick={handlePrint} className="text-gray-600 hover:text-gray-800">Print</button>
                            </td>
                        </tr>
                    ))}
                </tbody>
